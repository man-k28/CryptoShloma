                ...
                Column {
                    Row {
                        ...
                        TableToolButton {
                            ...
                            onClicked: {
                                volumeMarketsPopup.model = model
                                volumeMarketsPopup.market = model.market
                                volumeMarketsPopup.button.text = qsTr("Start %1").arg(rowWrapper.label)
                                volumeMarketsPopup.open()
                            }
                        }
                    }
